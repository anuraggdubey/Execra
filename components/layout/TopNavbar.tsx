            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                {!mounted ? (
                    ...
                    <div className="flex items-center gap-1.5">
                        {walletAddress && (
                            <div className="hidden items-center gap-2 rounded-lg border border-border px-3 py-1.5 text-xs sm:flex">
                        ...
                        <ConnectWalletButton className={walletAddress ? "button-secondary text-xs" : "button-primary text-xs"} />
                        {walletAddress && (
                            <button onClick={() => void disconnectWallet()} className="button-ghost text-xs">
                                Disconnect
                            </button>
                        )}
                    </div>
